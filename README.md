...
```
├── data/                # Raw & cleaned datasets (not included if confidential)
├── notebooks/           # Jupyter / Python notebooks for analysis
├── src/                 # Reusable scripts or functions
├── reports/             # Final presentations or written analysis
...
* Visualizations using industry-standard libraries
